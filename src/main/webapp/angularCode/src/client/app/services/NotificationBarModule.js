(function (root, factory) {
    ...
    module.factory('notifications', ['$rootScope', function ($rootScope) {
        ...
        var closeAllErrors = function () {
            $rootScope.$broadcast('notifications:closeAllErrors');
        };

        var closeAllWarnings = function () {
            $rootScope.$broadcast('notifications:closeAllWarnings');
        };
        ...
        return {
            ...
            closeAllWarnings: closeAllWarnings
        };
    }]);

    module.directive('notificationsBar', ['notificationsConfig', '$timeout', '$linq', function (notificationsConfig, $timeout, $linq) {
        return {
            restrict: 'EA',
            ...
            link: function (scope) {
                ...
                scope.$on('notifications:closeAllErrors', function () {
