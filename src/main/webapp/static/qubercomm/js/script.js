...
function rpcACL(uid, ap, macid,cmd) {
   	...
   	var url="/facesix/rest/acl/rpcacl?args=none&uid=" + uid + "&ap="+ap + "&mac="+macid + "&cmd="+cmd+"&sid="+sid+"&spid="+spid+"&cid="+cid;
   	console.log(url);
...
$('.logclear').on("click",function(){
	localStorage.setItem("someVarKeyVal", "play");
	localStorage.setItem("someVarKey", "play");
})