        ...
        _bind: function() {
            ...
            if ($zoomIn.length && $zoomOut.length) {
                ...
                $zoomIn.on(str_click, function(e) {
                    ...
                    var value=parseFloat($(".zoom-range").val());
                    $(".zoom-range").val(value+1.0)
                    self.zoom(parseFloat($(".zoom-range").val()), {
                        noSetRange: true
                    });
                });
                $zoomOut.on(str_click, function(e) {
                    ...
                    var value=parseFloat($(".zoom-range").val());
                    $(".zoom-range").val(value-1.0)
                    $(".zoom-range").val() == "1" ? $(".panzoom").panzoom("setMatrix", [1, 0, 0, 1, 0, 0]) : self.zoom(parseFloat($(".zoom-range").val()), {
                        noSetRange: false
                    });
                });;
